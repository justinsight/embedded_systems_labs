...
// This will keep track of the number of times the SysTick_Handler is called.
static volatile uint8_t SysTick_Handler_call_count = 0;
static volatile bool    SysTick_Handler_toggle     = false;
